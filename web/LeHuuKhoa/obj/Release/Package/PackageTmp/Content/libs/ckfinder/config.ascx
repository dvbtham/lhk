...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return HttpContext.Current.User.Identity.IsAuthenticated && (HttpContext.Current.User.IsInRole("Admin") || HttpContext.Current.User.IsInRole("Mod"));
    }
    ...
    public override void SetConfig()
    {
        ...
        else if (HttpContext.Current.User.IsInRole("Mod"))
        {
            AccessControl acl = AccessControl.Add();
            acl.Role = "Mod";
            acl.ResourceType = "*";
